...
describe('swigify', function() {
  ...
  it('should render included template', function() {
    ...
    chai.expect(result).to.contain('<div id="parent">');
    chai.expect(result).to.contain('<h1>Bodo</h1>');
    chai.expect(result).to.contain('<h2>Bodo</h2>');
    chai.expect(result).to.contain('</div>');
  });
