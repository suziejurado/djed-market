...
function transformFilename(file, doVersion) {
    var filename;
    ...
    if (doVersion) {
        filename = path.basename(file.path, ext) + '-' + hash + ext;
        file.path = path.join(path.dirname(file.path), filename);
    }
}

var plugin = function(doVersionFilename) {
    var sourcemaps = [];
    var pathMap = {};
    ...
    return through.obj(function(file, enc, cb) {
        ...
        transformFilename(file, doVersionFilename);
